...
public partial class CameraRenderer {
    ...
    static ShaderTagId unlitShaderTagId = new ShaderTagId("SRPDefaultUnlit"); //shader标签
    ...
    void DrawVisibleGeometry () {
        ...
        var drawingSettings = new DrawingSettings(unlitShaderTagId, sortingSettings); //渲染设置, 用于指定支持可以被渲染的shader标签
